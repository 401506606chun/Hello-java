...
public class ApiDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		reqMap.put("outOrderNo", "zx" + System.currentTimeMillis());// 上送流水号，保证唯一性
		// 调用考拉其他产品替换成相关的业务参数
		reqMap.put("entName", "赣州市凯峻电器有限责任公司");
		reqMap.put("entRegNo", "360702210001604");
		reqMap.put("repName", "王海军");
		reqMap.put("repIdNo", "622822199203011317");
		...
		signMap.put("prdGrpId", "icQuery");
		signMap.put("prdId", "saicCompare");
