...
public class Demo_qryBankCardBy4Element {
	...
	public static void main(String[] args) throws Exception {
		...
		// 调用考拉其他产品替换成相关的业务参数
		reqMap.put("name", "王韧");
		reqMap.put("accountNo", "6214920204237310");
		reqMap.put("idCardCore", "110108198704116334");
		reqMap.put("bankPreMobile", "13812342425");
		...
		signMap.put("prdId", "qryBankCardBy4Element");
